...
- 项目：zhanglei10281852-gif/gogo-11
- 项目用途：Go coding agent annotation task from cronchecker (11)
- Go 工具链：`golang:1.22`
- 前端工具链：无
...
1. 预期退出码 0：`go test ./pkg/cron -run "^(TestNextLeapDayAcrossFourYears|TestAllBetweenEnumeratesLeapDaysAcrossYears|TestAllBetweenFrequentSchedule)$" -count=1 -v`
